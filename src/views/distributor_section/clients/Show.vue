...
const filteredDomains = computed(() => {
  ...
  return domains.value.filter((domain) => {
    const matchesStatus = domainStatusInput.value === 'TODOS' || domain.status.toUpperCase() === domainStatusInput.value.slice(0, -1)
